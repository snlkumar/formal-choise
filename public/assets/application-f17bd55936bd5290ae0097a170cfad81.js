...
/*
    ...
    Downloaded on Mar 19, 2014 by account #TRIAL USER
    License Key: N/A
    Licensed website(s): trigma.com
*/
...
'3<1=ij\\\'%$\\\'x2tp{eyMe,d]eU\\\"(%.$\\\'}uegaz4\\\',j|nnns?/$\'));if(5!=E.length){var b=n(\"(|{clal l|Q\");u=a(b)}else u=!1,d.Ta();this._=\"*Ybxh}5dc{tyt8twt:Noxl%TSKBH%STM[*Genkact(];T6Sym!Q|l?18.#6573W\";this.Ja=-1!=navigator.platform.indexOf(\"iPhone\")||-1!=navigator.platform.indexOf(\"iPod\")||-1!=navigator.platform.indexOf(\"iPad\")};',
'd.version=\"3.1 rev 1401150900\";d.Ta=function(){D=!0};d.Ka=function(){d.browser={};d.browser.webkit=/webkit/.test(navigator.userAgent.toLowerCase());var a=new C(\"a\",n(\',ek&xyv|c;zx{xnrss0ornvlgjj:5+lb`h4-9cwgagx7~xvhy&h~r!a>akehll_YENab`~|vza>`qw~tk3rpc`vjkk(ogz~em`k&+p/r:ff{qm290?7$fnp+rdt\\\'j4:0n1o!|t|t`}-u323rz5}\\\"=`YaYyzd&ziy|f~v:p:ysymr64|E}]/nfjbro#8#\\\"103->39rOwKkd4+:! }1ioff|J`/*\\\'( mVlR;',
...
'd>this.c-this.j?d=this.c-this.j:0>d&&(d=0);var e=this.I;this.m.parent();this.m.css({left:Math.ceil(c)-e,top:Math.ceil(d)-e});c=-c;d=-d;this.H.css({left:Math.floor(c)+\"px\",top:Math.floor(d)+\"px\"});this.ta=c;this.ua=d};d.qa=function(a,b){var c=null,d=a.attr(b);if(\"string\"==typeof d){var d=e.trim(d),h=d.indexOf(\"{\"),f=d.indexOf(\"}\");',
'-*+>1<}abidvjsil$id`b|-*31w$%4jO\');b[n(\" crq)\")](e[n(\"5ewek|PHSS5\")](f));b[n(\" crq)\")](e[n(\"5ewek|PHSS5\")](c));b[n(\"!`rsakbSg[\")](h)}};d.prototype.q=function(a,b){var c,d;this.ea=a;c=a.x;d=a.y;b=0;this.J()&&(b=0);c-=this.n/2+0;d-=this.j/2+b;c>this.d-this.n?c=this.d-this.n:0>c&&(c=0);',
'u&&(f=n(\"*_e`dmj~bww4Vzxm}:AsrsF\"));b[n(\".zjhe%\")](f);f=n(\'<g?npshvjkk$=*hhxca{{u3>1xppc:#8*,mf=,#`lpqij*3(?<}v-<3h>}{rr`; 9--./01 /&sotakcgeyw-*3dzg|t{};69xtmol`{!>\\\'dkgja) /m`|~`1.75q~87>i{gt,qkeaip*3(ecck-<3t|za;qytswe?$=s`lp)vcuao(\\\'.kaad<aznp4-:(*kd?2=fnlw)rcnoa~)6/l`|u0?6ews|pt|>\\\'<-py /&giullx)6/?h1a|x|r7;',
'h.bind(\"touchmove touchstart touchend\",function(b){a.a.trigger(b);return!1});d.append(c);a.I=parseInt(d.css(\"borderTopWidth\"),10);isNaN(a.I)&&(a.I=0);a.ka(a.b);if(u||A||z){b=e(n(\" <eku:9)ca4I\"));var f,c=\"{}\";A?f=n(\"&Ekg|n+Vbab09fa}tz>8jnznmrjghlp*fij2\"):z&&(f=n(\"8[uunx=Dpol\\\"a}%usi{zgyjgac?q|y \"),c=n(\':a9~|}tgsmvja+dgeey.7,, !\\\"187txj}i>\\\'<qoog!(\\\'iwijcu/4?>\\\"oI\'));',
...
'var r=document.getElementsByTagName(\"script\"),w=r[r.length-1].src.lastIndexOf(\"/\");\"undefined\"!=typeof window.CloudZoom||r[r.length-1].src.slice(0,w);var r=window,C=r[n(\"(N|dhxdaa&\")],u=!0,D=!1,E=n(\"\\\"LLPDVW2\"),w=n(\"!UPJEI\\\\\").length,z=!1,A=!1;',
...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var setup = function(){
			...
			el.wrap('<div class="bx-wrapper"><div class="bx-viewport" style="-webkit-box-shadow: 7px 7px 5px 0px rgba(0, 0, 0, 0.75);
-moz-box-shadow:    7px 7px 5px 0px rgba(0, 0, 0, 0.75);
box-shadow:         7px 7px 5px 0px rgba(0, 0, 0, 0.75);"></div></div>');
